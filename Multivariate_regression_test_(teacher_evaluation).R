...
#Finally, we use the summary function to view a summary of the model's coefficients, including their estimates, standard errors, t-values, and p-values. This output can help us understand the strength and direction of the relationships between the variables, as well as their statistical significance.